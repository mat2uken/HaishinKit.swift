...
struct VTSessionOptionKey: RawRepresentable {
    ...
    @available(iOS 16.0, tvOS 16.0, macOS 13.0, *)
    static let maxAllowedFrameQP = VTSessionOptionKey(rawValue: kVTCompressionPropertyKey_MaxAllowedFrameQP as String)
    @available(iOS 16.0, tvOS 16.0, macOS 13.0, *)
    static let minAllowedFrameQP = VTSessionOptionKey(rawValue: kVTCompressionPropertyKey_MinAllowedFrameQP as String)
    let rawValue: String
